# Fax to PDF to TIF Processor

This example demonstrates how you can use Apache Camel with Spring Boot to create a fax processing route, accepting PDF documents from a third-party Fax service, separating them into single pages then saving them as individual TIF images.
